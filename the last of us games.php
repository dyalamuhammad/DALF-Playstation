...
<body>
    ...
    <div class="container">
        <div class="product-image">
            <img src="gambar/games/5.png" alt="Product Image">
        </div>
        <div class="product-title">The Last Of Us: Part 1</div>
        <div class="product-price">Rp250.000</div>
        <div class="product-description">
            <p>Experience the emotional storytelling and unforgettable characters in The Last of Us™, winner of over 200 Game of the Year awards.</p>
        </div>
