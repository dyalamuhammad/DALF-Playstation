...
<body>
    ...
    <div class="container">
        <div class="product-image">
            <img src="gambar/console/4.png" alt="Product Image">
        </div>
        <div class="product-title">PlayStation 4</div>
        <div class="product-price">Rp4.250.000</div>
        <div class="product-description">
            <p>PlayStation 4 (PS4) adalah konsol permainan video yang dikembangkan oleh Sony. Konsol ini memiliki desain yang elegan dan modern. PS4 memiliki kemampuan grafis yang lebih baik dibandingkan dengan konsol sebelumnya. Kontroler yang disertakan adalah DualShock 4 yang nyaman di tangan dan dilengkapi dengan berbagai fitur tambahan. PS4 memiliki perpustakaan permainan yang luas dengan banyak judul populer.</p>
        </div>
