...
<body>
    ...
    <div class="container">
        <div class="product-image">
            <img src="gambar/hyperxps4.png" alt="Product Image">
        </div>
        <div class="product-title">PlayStation® HyperX Cloud Gaming Headset</div>
        <div class="product-price">Rp599.000</div>
        <div class="product-description">
            <p>Headset HyperX Cloud adalah Produk Berlisensi Resmi PlayStation®.</p>
            <p>Rasakan kenyamanan khas HyperX dengan bantalan telinga busa memori mewah yang dibungkus kulit imitasi premium. Benamkan diri Anda di dunia game dengan audio sejernih kristal dan bass yang disempurnakan. Lakukan petualangan baru dengan headset yang didesain tahan lama, dengan rangka aluminium yang kokoh. Mikrofon peredam bising dapat dilepas sehingga Anda dapat mengobrol dengan teman atau melepasnya saat tidak diperlukan. Saat Anda perlu membisukan diri sendiri atau menyesuaikan volume dengan cepat, kontrol audio in-line ada di ujung jari Anda.</p>
        </div>
