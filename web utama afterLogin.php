...
// Periksa apakah ada notifikasi yang disimpan dalam session
...
<body>
    ...
    <section class="home" id="home">
        <div class="home-text">
            ...
            <a href="playstation5 product.php" class="btn">View Collection</a>
        </div>
    </section>
    ...
    <section class="featured" id="featured">
        ...
        <div class="featured-content">
            <div class="row">
				...
				<div class="arrow">
					<a href="headset.php"><i class='bx bx-right-arrow-alt' ></i></a>
				</div>
			</div>
            ...
            <div class="row">
				...
				<div class="arrow">
					<a href="controller.php"><i class='bx bx-right-arrow-alt' ></i></a>
				</div>
			</div>
            ...
            <div class="row">
				...
				<div class="arrow">
					<a href="console.php"><i class='bx bx-right-arrow-alt' ></i></a>
				</div>
			</div>
            ...
            <div class="row">
				...
				<div class="arrow">
					<a href="vr.php"><i class='bx bx-right-arrow-alt' ></i></a>
				</div>
			</div>
            ...
            <div class="row">
				...
				<div class="arrow">
					<a href="games.php"><i class='bx bx-right-arrow-alt' ></i></a>
				</div>
			</div>
            ...
            <div class="row">
				...
				<div class="arrow">
					<a href="psplus.php"><i class='bx bx-right-arrow-alt' ></i></a>
				</div>
			</div>
        </div>
    </section>
    ...
    <section class="cta">
        <div class="cta-text">
            ...
            <a href="console.php" class="btn">Shop Now</a>
        </div>
    </section>
    ...
    <section class="home2" id="home2">
        <div class="home2-text">
            ...
            <a href="psplus.php" class="btn" style="background-color: white; color: black;">Upgrade</a>
        </div>
    </section>
    ...
    <script>
        ...
        // Memperbarui tombol login menjadi nama pengguna
        if (loggedInUsername) {
            document.getElementById("btnUsername").innerHTML = loggedInUsername;
        }
    </script>
</body>
</html>