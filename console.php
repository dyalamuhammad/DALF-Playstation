...
<body>
    ...
    <div class="container">
        ...
        <div class="product-list">
            <div class="product">
                <img src="gambar/console/1.png" alt="Product 1">
                <p>PlayStation 1</p>
                <span class="harga-headset">Rp850.000</span><br><br>
                <a href="playstation1 product.php" class="btn">Beli</a>
            </div>
            <div class="product">
                <img src="gambar/console/2.png" alt="Product 2">
                <p>Playstation 2</p>
                <span class="harga-headset">Rp1.500.000</span><br><br>
                <a href="playstation2 product.php" class="btn">Beli</a>
            </div>
            <div class="product">
                <img src="gambar/console/3.png" alt="Product 3">
                <p>Playstation 3</p>
                <span class="harga-headset">Rp3.000.000</span><br><br>
                <a href="playstation3 product.php" class="btn">Beli</a>
            </div>
            <div class="product">
                <img src="gambar/console/4.png" alt="Product 3">
                <p>PlayStation 4</p>
                <span class="harga-headset">Rp4.250.000</span><br><br>
                <a href="playstation4 product.php" class="btn">Beli</a>
            </div>
            <div class="product">
                <img src="gambar/console/5.png" alt="Product 3">
                <p>PlayStation 5</p>
                <span class="harga-headset">Rp9.050.000</span><br><br>
                <a href="playstation5 product.php" class="btn">Beli</a>
            </div>
        </div>
    </div>
