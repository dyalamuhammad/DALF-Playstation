...
<body>
    ...
    <div class="container">
        <div class="product-image">
            <img src="gambar/stikps5.png" alt="Product Image">
        </div>
        <div class="product-title">DualSense</div>
        <div class="product-price">Rp1.099.000</div>
        <div class="product-description">
            <p>DualSense adalah kontroler permainan yang dikembangkan oleh Sony untuk digunakan dengan konsol game PlayStation 5 (PS5). DualSense membawa sejumlah fitur inovatif dan peningkatan dibandingkan kontroler sebelumnya, menciptakan pengalaman bermain game yang lebih immersif dan mendalam pada PlayStation 5.</p>
        </div>
