...
<body>
    ...
    <div class="container">
        <div class="product-image">
            <img src="gambar/stikps4.png" alt="Product Image">
        </div>
        <div class="product-title">DualShock 4</div>
        <div class="product-price">Rp799.000</div>
        <div class="product-description">
            <p>DualShock 4 adalah kontroler permainan yang dikembangkan oleh Sony untuk digunakan dengan konsol game PlayStation 4 (PS4). DualShock 4 telah menjadi kontroler standar untuk PlayStation 4 dan mendukung banyak fitur dan fungsionalitas yang disematkan dalam permainan PS4. Dengan desain yang nyaman, fitur touchpad, sensor gerak, teknologi getar yang ditingkatkan, dan konektivitas nirkabel, DualShock 4 memungkinkan pengalaman bermain game yang lebih imersif dan interaktif.</p>
        </div>
