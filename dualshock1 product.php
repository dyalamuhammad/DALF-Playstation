...
<body>
    ...
    <div class="container">
        <div class="product-image">
            <img src="gambar/stikps1.png" alt="Product Image">
        </div>
        <div class="product-title">DualShock 1</div>
        <div class="product-price">Rp199.000</div>
        <div class="product-description">
            <p>DualShock 1 adalah kontroler permainan yang dirancang khusus untuk konsol game PlayStation 1 (PS1). Ini adalah kontroler pertama yang dilengkapi dengan teknologi getar, yang memungkinkan para pemain merasakan sensasi getaran selama bermain game. DualShock 1 adalah kontroler ikonik yang memperkenalkan fitur getar yang menjadi fitur standar pada kontroler PlayStation selanjutnya. Meskipun telah digantikan oleh versi kontroler yang lebih canggih dan ditingkatkan, DualShock 1 tetap menjadi bagian penting dari sejarah permainan video dan menjadi fondasi bagi perkembangan kontroler selanjutnya dalam seri PlayStation. </p>
        </div>
