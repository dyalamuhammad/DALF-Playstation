...
<body>
    ...
    <div class="container">
        ...
        <div class="product-list">
            <div class="product">
                <img src="gambar/stikps1.png" alt="Product 1">
                <p>DualShock 1</p>
                <span class="harga-headset">Rp199.000</span><br><br>
                <a href="dualshock1 product.php" class="btn">Beli</a>
            </div>
            <div class="product">
                <img src="gambar/stikps2.png" alt="Product 2">
                <p>DualShock 2</p>
                <span class="harga-headset">Rp259.000</span><br><br>
                <a href="dualshock2 product.php" class="btn">Beli</a>
            </div>
            <div class="product">
                <img src="gambar/stikps3.png" alt="Product 3">
                <p>DualShock 3</p>
                <span class="harga-headset">Rp449.000</span><br><br>
                <a href="dualshock3 product.php" class="btn">Beli</a>
            </div>
            <div class="product">
                <img src="gambar/stikps4.png" alt="Product 3">
                <p>DualShock 4</p>
                <span class="harga-headset">Rp799.000</span><br><br>
                <a href="dualshock4 product.php" class="btn">Beli</a>
            </div>
            <div class="product">
                <img src="gambar/stikps5.png" alt="Product 3">
                <p>DualSense</p>
                <span class="harga-headset">Rp1.099.000</span><br><br>
                <a href="dualsense product.php" class="btn">Beli</a>
            </div>
        </div>
    </div>
