...
<body>
    ...
    <div class="container">
        <div class="product-image">
            <img src="gambar//stikps2.png" alt="Product Image">
        </div>
        <div class="product-title">DualShock 2</div>
        <div class="product-price">Rp259.000</div>
        <div class="product-description">
            <p>DualShock 2 adalah kontroler permainan yang dirancang untuk digunakan dengan konsol game PlayStation 2 (PS2). DualShock 2 memperbaiki beberapa fitur dari pendahulunya dan menawarkan kontrol yang lebih halus dan presisi. Kontroler ini menjadi salah satu kontroler game yang paling populer dan ikonik dalam sejarah permainan video, dan banyak game pada platform PlayStation 2 dan PlayStation 1 dirancang dengan mempertimbangkan fitur-fitur kontroler ini.</p>
        </div>
