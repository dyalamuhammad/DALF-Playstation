...
<body>
    ...
    <div class="container">
        <div class="product-image">
            <img src="gambar/console/3.png" alt="Product Image">
        </div>
        <div class="product-title">PlayStation 3</div>
        <div class="product-price">Rp3.000.000</div>
        <div class="product-description">
            <p>PlayStation 3 (PS3) adalah konsol permainan video yang dikembangkan oleh Sony. Konsol ini memiliki desain elegan dengan bentuk melengkung dan warna hitam yang mencolok. PS3 memiliki kemampuan grafis yang lebih baik daripada pendahulunya, PlayStation 2, dan menggunakan format Blu-ray sebagai media utama. Kontroler yang disertakan adalah DualShock 3 dengan fitur getaran dan teknologi deteksi gerakan. PS3 juga memiliki fitur online melalui layanan PlayStation Network (PSN) yang memungkinkan pemain untuk bermain game online, mengunduh konten tambahan, dan mengakses berbagai aplikasi. PlayStation 3 memiliki perpustakaan permainan yang beragam, termasuk game-game populer seperti Uncharted, God of War, dan Gran Turismo.</p>
        </div>
