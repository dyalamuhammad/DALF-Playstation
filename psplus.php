...
<body>
    ...
    <div class="container">
        ...
        <div class="product-list">
            <div class="product">
                <img src="gambar/psplus/1.png" alt="Product 1">
                <p>PlayStation Plus 3 Month</p>
                <span class="harga-headset">Rp100.000</span><br><br>
                <a href="psplus 3.php" class="btn">Beli</a>
            </div>
            <div class="product">
                <img src="gambar/psplus/2.png" alt="Product 2">
                <p>Playstation Plus 12 Month</p>
                <span class="harga-headset">Rp300.000</span><br><br>
                <a href="psplus 12.php" class="btn">Beli</a>
            </div>
            <div class="product">
                <img src="gambar/psplus/2.png" alt="Product 2">
                <p>Playstation Plus 15 Month</p>
                <span class="harga-headset">Rp400.000</span><br><br>
                <a href="psplus 15.php" class="btn">Beli</a>
            </div>
        </div>
    </div>
