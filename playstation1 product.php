...
<body>
    ...
    <div class="container">
        <div class="product-image">
            <img src="gambar/console/1.png" alt="Product Image">
        </div>
        <div class="product-title">PlayStation 1</div>
        <div class="product-price">Rp850.000</div>
        <div class="product-description">
            <p>PlayStation 1 (PS1) adalah konsol permainan video yang dirilis oleh Sony pada tahun 1994. Dengan desain yang khas berbentuk persegi panjang dan warna abu-abu, PS1 menjadi populer di kalangan pemain. Konsol ini menggunakan CD-ROM sebagai media utama dan memiliki kemampuan grafis 3D yang canggih untuk masa itu. Kontroler DualShock yang disertakan memiliki desain ergonomis dan fitur getar. PS1 memiliki perpustakaan permainan yang luas, termasuk judul-judul yang populer seperti Final Fantasy, Crash Bandicoot, dan Metal Gear Solid. PlayStation 1 menjadi tonggak dalam sejarah industri permainan video dan memberikan pengalaman bermain yang tak terlupakan bagi banyak orang.</p>
        </div>
