...
<body>
    ...
    <div class="container">
        <div class="product-image">
            <img src="gambar/stikps3.png" alt="Product Image">
        </div>
        <div class="product-title">DualShock 3</div>
        <div class="product-price">Rp449.000</div>
        <div class="product-description">
            <p>DualShock 3 adalah kontroler permainan yang dikembangkan oleh Sony untuk digunakan dengan konsol game PlayStation 3 (PS3). DualShock 3 menjadi standar kontroler untuk PlayStation 3 dan banyak game pada platform tersebut dirancang untuk mendukung fitur-fitur kontroler ini. Dengan desain yang nyaman, kemampuan getar yang responsif, sensor gerak Sixaxis, dan konektivitas nirkabel, DualShock 3 memberikan pengalaman bermain game yang lebih imersif dan interaktif.</p>
        </div>
