...
<body>
    ...
    <div class="container">
        ...
        <div class="product-list">
            <div class="product">
                <img src="gambar/games/1.png" alt="Product 1">
                <p>Uncharted Legacy Collection</p>
                <span class="harga-headset">Rp250.000</span><br><br>
                <a href="uncharted games.php" class="btn">Beli</a>
            </div>
            <div class="product">
                <img src="gambar/games/2.png" alt="Product 2">
                <p>Spiderman Miles Morales</p>
                <span class="harga-headset">Rp250.000</span><br><br>
                <a href="spiderman games.php" class="btn">Beli</a>
            </div>
            <div class="product">
                <img src="gambar/games/3.png" alt="Product 3">
                <p>Gran Turismo 7</p>
                <span class="harga-headset">Rp250.000</span><br><br>
                <a href="grand games.php" class="btn">Beli</a>
            </div>
            <div class="product">
                <img src="gambar/games/4.png" alt="Product 3">
                <p>The Show 23</p>
                <span class="harga-headset">Rp250.000</span><br><br>
                <a href="the show games.php" class="btn">Beli</a>
            </div>
            <div class="product">
                <img src="gambar/games/5.png" alt="Product 3">
                <p>The Last Of Us: Part 1</p>
                <span class="harga-headset">Rp250.000</span><br><br>
                <a href="the last of us games.php" class="btn">Beli</a>
            </div>
            <div class="product">
                <img src="gambar/games/6.png" alt="Product 3">
                <p>God Of War Ragnarok</p>
                <span class="harga-headset">Rp250.000</span><br><br>
                <a href="god of war games.php" class="btn">Beli</a>
            </div>
        </div>
    </div>
