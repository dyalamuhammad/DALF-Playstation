...
<body>
    ...
    <div class="container">
        <div class="product-image">
            <img src="gambar/console/5.png" alt="Product Image">
        </div>
        <div class="product-title">PlayStation 5</div>
        <div class="product-price">Rp9.050.000</div>
        <div class="product-description">
            <p>PlayStation 5 (PS5) adalah konsol permainan video generasi kelima yang dikembangkan oleh Sony. Konsol ini memiliki desain yang unik dan futuristik. PS5 menawarkan kemampuan grafis yang canggih dengan dukungan resolusi 4K dan teknologi ray tracing. Konsol ini dilengkapi dengan SSD cepat yang mengurangi waktu muat dan loading dalam permainan. Kontroler yang disertakan adalah DualSense dengan fitur getar adaptif. PlayStation 5 menyediakan pengalaman permainan yang canggih dan memukau.</p>
        </div>
