...
<body>
    ...
    <div class="container">
        <div class="product-image">
            <img src="gambar/vr/1.png" alt="Product Image">
        </div>
        <div class="product-title">PlayStation VR White</div>
        <div class="product-price">Rp5.199.000</div>
        <div class="product-description">
            <p>PlayStation VR adalah sistem realitas virtual (VR) yang dikembangkan oleh Sony. Sistem ini terdiri dari headset yang dikenakan di kepala pemain dan kompatibel dengan PlayStation 4 dan PlayStation 5. PlayStation VR memungkinkan pemain untuk merasakan pengalaman permainan yang mendalam dan imersif dalam lingkungan virtual.</p>
        </div>
