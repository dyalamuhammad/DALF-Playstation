...
<body>
    ...
    <div class="container">
        <div class="product-image">
            <img src="gambar/games/4.png" alt="Product Image">
        </div>
        <div class="product-title">The Show 23</div>
        <div class="product-price">Rp250.000</div>
        <div class="product-description">
            <p>MLB® The Show™ 23 gets you closer than ever to living your baseball dreams on the diamond. Shock the game and Own The Show™ with your favourite players, your favourite rivalries and all your favourite MLB® moments.

Get the next-generation MLB The Show experience when you play on PlayStation® 5 consoles, including the return of Stadium Creator mode, and face your friends with cross-platform play.2 With cross progression, continue your progress and earn and use content on other console platforms.</p>
        </div>
