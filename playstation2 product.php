...
<body>
    ...
    <div class="container">
        <div class="product-image">
            <img src="gambar/console/2.png" alt="Product Image">
        </div>
        <div class="product-title">PlayStation 2</div>
        <div class="product-price">Rp1.500.000</div>
        <div class="product-description">
            <p>PlayStation 2 (PS2) adalah konsol permainan video yang dikembangkan oleh Sony. Konsol ini memiliki desain yang ramping dan modern dengan slot disk optik di bagian depan untuk memuat permainan menggunakan format DVD-ROM. PS2 memiliki kemampuan grafis yang lebih baik dibandingkan dengan pendahulunya, PlayStation 1, dan kompatibel dengan permainan PlayStation 1. Kontroler yang disertakan adalah DualShock 2 dengan desain yang serupa dengan tambahan tombol analog L3 dan R3. PS2 juga dapat berfungsi sebagai pemutar DVD dan CD audio. Konsol ini memiliki perpustakaan permainan yang luas dan populer, menjadikannya salah satu konsol game terlaris sepanjang masa.</p>
        </div>
